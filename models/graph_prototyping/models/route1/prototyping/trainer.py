# -*- coding: utf-8 -*-
"""
Created on 2025-07-30 (Wed) 18:26:40

@author: I.Azuma
"""
# %%
BASE_DIR = '/workspace/cluster/HDD/azuma/Pathology_Graph/github/PathoGraphX/models/graph_prototyping'
ROUTE = 'route1.prototyping'
...
model_module = importlib.import_module(f"models.{ROUTE}")


PrototypeTokenizer = model_module.tokenizer.PrototypeTokenizer
create_downstream_model = model_module.create_downstream_model
prepare_emb = model_module.prepare_emb
...
def prot_embed(datasets, args, mode='classification'):
...
def validate_classification(model, loader,
    ...
    #print(f"n_classes = {n_classes}, all_probs.shape = {all_probs.shape}, all_labels.shape = {all_labels.shape}, all_preds.shape = {all_preds.shape}")
