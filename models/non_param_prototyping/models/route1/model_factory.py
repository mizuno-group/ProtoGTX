...
"""
from models.route1.model_PANTHER import PANTHER
from models.route1.model_linear import LinearEmb
from models.configs.model_configs import PANTHERConfig, LinearEmbConfig
...
def create_embedding_model(args, mode='classification'):  # FIXME: hardcoding
    """
    Create classification or survival models
    """
    config_path = os.path.join(args.config_dir, f'{args.model_type}_config.json')
...
def create_downstream_model(args, mode='classification'):
    """
