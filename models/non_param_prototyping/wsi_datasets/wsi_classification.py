...
class WSIClassificationDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.data_df[self.slide_col] = self.data_df[self.slide_col].apply(lambda x: x.split('.')[0])  # ***.svs --> *** for slide_col
    ...
    def set_feat_paths_in_df(self):
        ...
        #missing_feats_in_split = series_diff(self.data_df[self.slide_col].apply(lambda x : x.split('.')[0]), self.feats_df[self.slide_col])  # C3L-05022-24.svs --> C3L-05022-24
